...
const translations: Record<AppLanguage, Record<TranslationKey, string>> = {
  en: {
    ...
    'app.loading': 'Loading',
    'app.loadingSubtitle': 'Preparing BM Quest KSSM...',
    ...
    'badges.subtitle': 'Celebrate your BM Quest KSSM learning milestones.',
    'badges.unlocked': 'Unlocked',
    'badges.locked': 'Locked',
    'badges.firstLessonTitle': 'First Lesson',
    'badges.firstLessonDescription': 'Completed your first BM Quest KSSM lesson.',
    ...
    'settings.subtitle': 'Manage your BM Quest KSSM account and app preferences.',
    'settings.bmQuestName': 'BM Quest KSSM Name',
    ...
    'settings.nicknameSubtitle': 'This is the name shown in BM Quest KSSM and on arcade high scores instead of your Google account name.',
    ...
    'settings.about': 'About BM Quest KSSM',
  ...
  ms: {
    ...
    'app.loadingSubtitle': 'BM Quest KSSM sedang disediakan...',
    ...
    'badges.subtitle': 'Raikan pencapaian pembelajaran anda dalam BM Quest KSSM.',
    'badges.unlocked': 'Dibuka',
    'badges.locked': 'Terkunci',
    'badges.firstLessonTitle': 'Pelajaran Pertama',
    'badges.firstLessonDescription': 'Selesaikan pelajaran BM Quest KSSM pertama anda.',
    ...
    'settings.subtitle': 'Urus akaun BM Quest KSSM dan pilihan aplikasi anda.',
    'settings.bmQuestName': 'Nama BM Quest KSSM',
    ...
    'settings.nicknameSubtitle': 'Nama ini dipaparkan dalam BM Quest KSSM dan pada skor tinggi arked, menggantikan nama akaun Google anda.',
    ...
    'settings.about': 'Tentang BM Quest KSSM',
